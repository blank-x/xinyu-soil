<template>
    <el-tooltip effect="dark" :content="windowStatus !== false ? '退出全屏':'全屏'" placement="bottom">
        <div @click='click'>
            <icon :name="windowStatus !== false? 'window-restore' :'window-maximize'" class="screenfull"></icon>
        </div>
    </el-tooltip>
