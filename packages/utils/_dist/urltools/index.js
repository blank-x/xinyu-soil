...
exports.getUrlParams = exports.setUrlParams = exports.makeUrl = exports.parseUrl = exports.isValidUrl = exports.parseQuery = exports.makeQuery = void 0;
 ...
 * @member KISSY
 */
function makeQuery(queryObj, sep, eq, serializeArray) {
    if (sep === void 0) { sep = '&'; }
    if (eq === void 0) { eq = '='; }
 ...
 */
function parseQuery(str, sep, eq) {
    if (sep === void 0) { sep = '&'; }
    if (eq === void 0) { eq = '='; }
...
function setUrlParams(url, addObj, delObj) {
